...
const placeArray: PlaceObject[] = [
    ...
    },
    {
        key: 1,
        title: "Greenery",
        placeName: "Epping Forest",
        countryName: "United Kingdom",
        img: "/img/idk.jpg",
        altMsg: "idk",
        mapLink: "https://www.google.com/maps?q=epping+forest&source=lmns&entry=mt&bih=708&biw=1440&hl=en&sa=X&ved=2ahUKEwiM2K6khO3_AhUptScCHdlJAjUQ_AUoAXoECAEQAQ",
    ...
    },
    {
        ...
        altMsg: "Mountains",
        mapLink: "https://www.google.com/maps?output=search&q=antalya&entry=mc&sa=X&ved=2ahUKEwiCr-ekn-3_AhWKIMAKHaD6AnMQ0pQJegQICxAB",
        description: "The mountains in Turkey"
    }
]
